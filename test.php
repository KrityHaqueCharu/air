    ...
    <div class="inside">
        <div class="container">
            <table class="table l">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><?php echo $from; ?></td>
                    <td><?php echo $to; ?></td>
                    <td><a href="about.php?update=<?php echo $id; ?>" class="btn btn-success">Update</a></td>
                    <td><a href="about.php?delete=<?php echo $id; ?>" class="btn btn-danger">Delete</a></td>
            ...
            <form action="" method="post" class="d-flex">
                ...
                <input type="submit" value="Add" name="btn" class="btn btn-info">
            </form><br>
            <form action="" method="post" class="d-flex">
                <?php
                  require_once('DBconnect.php');
                ...
                <input type="submit" value="Update" name="update-btn" class="btn btn-info">
                <?php
                     }}
                ?>
                <?php
